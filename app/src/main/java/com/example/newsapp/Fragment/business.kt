...
class business : Fragment() {
    ...
    lateinit var brecycler: RecyclerView
    ...
    override fun onCreateView(
        ...
        val b = inflater.inflate(R.layout.fragment_business, container, false)
        brecycler = b.findViewById(R.id.newsrecyclerbusinee)
        prog = b.findViewById(R.id.bpb)
        val newsdata = Newsservies.newsinstance.getnews("in", "business", 2)
        newsdata.enqueue(object : Callback<Newsgrp> {
            override fun onResponse(call: Call<Newsgrp>, response: retrofit2.Response<Newsgrp>) {
                ...
                brecycler.adapter = adapter
                brecycler.layoutManager = LinearLayoutManager(requireContext())
